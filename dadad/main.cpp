...
int main()
{
    ...
    cout<<"=============  BAI THUC HANH SO 4  =================\n";
      cout<<"\t1.nham phim 1 de chon bai 1.\n";
      cout<<"\t2.nham phim 2 de chon bai 2.\n";
      cout<<"\t3.nham phim 3 de chon bai 3.\n";
      cout<<"\t4.nham phim 4 de chon bai 4.\n";
      cout<<"\t5.nham phim 0 de thoat chuong trinh \n";
    do
    {
      cout<<"chon bai (tu 1-4 ): ";
      int chon;
      do
      {
          cin>>chon;
...
void Bai2()
{
    ...
    {
        cout<<"\n==================== CHON 1 CHUC NANG==================\n";
    cout<<"\t1.nhan 1 de hien ti thong tin tat ca goi hang.\n";
    cout<<"\t2.nhan 2 de hien thi goi hang lon nhat.\n";
    cout<<"\t3.nhan 3 de in ra ti trong goi hang lon.\n";
    cout<<"\t4.nhan 4 de sap xep giam dan.\n";
    cout<<"\t5.nhan 0 de thoat ve menu.\n";
        cin>>chon;
        if(chon<0 || chon>4)
        {
            cout<<"\nmoi nhap lai: ";
...
void Bai3()
{
    ...
    gets(HoVaTen);
    cout<<"\n==================== CHON 1 CHUC NANG ======================\n";
        cout<<"\n1.nhan 1 de hien thi.\n";
        cout<<"\n2.nhan 2 de chuan hoa. \n";
        cout<<"\n3.nhan 0 de tro ve menu chinh.";
        int chon;
    do
    {
        cin>>chon;
...
void Bai4()
{
    ...
    do
    {
        ...
        cout<<"\t2.nhan phim 2 de nhap MT vuong.\n";
        cout<<"\t3.nhan phim 3 de mo menu mo rong.\n";
        cout<<"\t4.nhan 0 de quay lai menu chinh.\n";
...
void Menu(int a[100][100],int n)
{
    do
    {
        ...
        cout<<"1.nhan 1 de hien thi ma tran.\n";
        cout<<"2.nhan 2 de hien thi tong cac dong.\n";
        cout<<"3.nhan 3 de kt ma tran don vi.\n";
        cout<<"4.nhan 4 de kt ma tran tam giac.\n";
        cout<<"5.nhan 0 de thoat menu.\n";
        int chon;
        do
        {
            cin>>chon;
